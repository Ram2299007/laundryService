...
class SelectPickupTimeAndDate1 extends StatefulWidget {
  const SelectPickupTimeAndDate1({super.key});

  @override
  State<SelectPickupTimeAndDate1> createState() => _SelectPickupTimeAndDate1State();
}

class _SelectPickupTimeAndDate1State extends State<SelectPickupTimeAndDate1> {
                        ...
                        Row(
                            children: [
                              ...
                              Switch(
                                ...
                                activeTrackColor:  Color.fromRGBO(58, 255, 90, 1),// Color of the track when the switch is on
